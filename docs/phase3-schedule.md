...
| 4-3 | Block 4 | 確認關節結構能用 API 讀取關節數量與名稱 | 0.5h | M2: 場景與機器人 | FALSE |  | 2026-07-13 | #87 |
| 4-3b | Block 4 | 建立 UR5Robot 類別（載入 Nucleus UR5 USD 設定世界座標） | 0.5h | M2: 場景與機器人 | FALSE |  | 2026-07-13 | #174 |
| 4-3c | Block 4 | UR5Robot Unit Test | 0.5h | M2: 場景與機器人 | FALSE |  | 2026-07-14 | #175 |
| 4-4 | Block 4 | 設計球桿幾何體（USD Prim）確認尺寸比例合理 | 0.5h | M2: 場景與機器人 | FALSE |  | 2026-07-14 | #88 |
| 4-5 | Block 4 | 設計球桿與 UR5 末端的固定連結（Fixed Joint） | 0.5h | M2: 場景與機器人 | FALSE |  | 2026-07-15 | #89 |
| 4-8 | Block 4 | 空揮測速：單獨場景量測 TCP 峰值速度（含 asset velocity/effort limit 檢查）→ 定 A 動作空間速度上限 | 3h | M2: 場景與機器人 | FALSE |  | 2026-07-18 | #176 |
| 9-0 | Block 9 | Early termination 設計確認（球靜止偵測 → 立即計算 reward 並 reset） | 0.5h | M5: RL 訓練與多環境 | FALSE |  | 2026-07-18 | #178 |
| 3-6 | Block 3 | 確認球的碰撞與滾動物理行為正常（PhysX 參數調校） | 1h | M2: 場景與機器人 | FALSE |  | 2026-07-18 | #81 |
| 3-9b | Block 3 | 場景整體穩定性確認，物理仿真無異常 | 0.5h | M2: 場景與機器人 | FALSE |  | 2026-07-18 | #153 |
| 5-1 | Block 5 | 設計擊球參數資料格式（放置XY 方向角 速度 偏移2）+ Unit Test | 0.5h | M3: 擊球動作與評估 | FALSE |  | 2026-07-18 | #92 |
| 5-2 | Block 5 | 設計 ScriptController 狀態機（A 版 STRIKING = set_velocities） | 0.5h | M3: 擊球動作與評估 | FALSE |  | 2026-07-18 | #93 |
| 5-3 | Block 5 | 撰寫狀態機 Unit Test（Mock ArticulationAPI） | 1h | M3: 擊球動作與評估 | FALSE |  | 2026-07-19 | #94 |
| 5-4 | Block 5 | 實作 ArticulationAPIImpl（isaac_sim_impl_6_0/） | 0.5h | M3: 擊球動作與評估 | FALSE |  | 2026-07-19 | #95 |
| 5-11 | Block 5 | 實作 impulse-based 擊球（set_velocities + spin_efficiency 轉換）+ Unit Test | 1h | M3: 擊球動作與評估 | FALSE |  | 2026-07-19 | #177 |
...
| 5-9 | Block 5 | 單次擊球循環跑通確認（set_velocities 版） | 0.5h | M3: 擊球動作與評估 | FALSE |  | 2026-07-19 | #100 |
| 5-10 | Block 5 | 物理參數調校：確認賦速後球散開效果合理 | 1h | M3: 擊球動作與評估 | FALSE |  | 2026-07-20 | #101 |
| 6-1 | Block 6 | 設計 ShotResult 資料格式（各球最終位置 進袋狀態 散開分數） | 0.5h | M3: 擊球動作與評估 | FALSE |  | 2026-07-20 | #102 |
| 6-2 | Block 6 | 實作散開分數（凸包面積×0.5 + 平均最近鄰距離×0.5）+ Unit Test | 1h | M3: 擊球動作與評估 | FALSE |  | 2026-07-21 | #103 |
| 6-3 | Block 6 | 實作白球進袋判定（−3.5）+ Unit Test | 0.5h | M3: 擊球動作與評估 | FALSE |  | 2026-07-22 | #104 |
| 6-4 | Block 6 | 實作 9 號球進袋加分判定（+3.0 無犯規）+ Unit Test | 0.5h | M3: 擊球動作與評估 | FALSE |  | 2026-07-22 | #105 |
| 6-7 | Block 6 | 實作犯規判定（未先觸 1 號球 −1.5 / 碰庫 < 4 −0.5）+ Unit Test | 1h | M3: 擊球動作與評估 | FALSE |  | 2026-07-23 | #154 |
| 6-5 | Block 6 | 實作 Reward Function（整合散開分數與進袋獎懲）+ Unit Test | 1h | M3: 擊球動作與評估 | FALSE |  | 2026-07-24 | #106 |
| 6-8 | Block 6 | 整合完整 Reward Function + Unit Test | 0.5h | M3: 擊球動作與評估 | FALSE |  | 2026-07-25 | #155 |
| 7-1 | Block 7 | 確認 Observation 資料格式（20 維：1–9 號球 XY + 母球 XY，無手臂資訊） | 0.5h | M3: 擊球動作與評估 | FALSE |  | 2026-07-25 | #108 |
| 7-1b | Block 7 | 實作 RigidBodyAPIImpl（isaac_sim_impl_6_0/，查詢球的位置與速度） | 0.5h | M3: 擊球動作與評估 | FALSE |  | 2026-07-25 | #156 |
| 7-2b | Block 7 | 實作 LivePositionProvider（isaac_sim_impl_6_0/，即時查詢球位置） | 0.5h | M3: 擊球動作與評估 | FALSE |  | 2026-07-25 | #157 |
| 7-2 | Block 7 | 實作 Observation 收集函式（從 RigidBodyAPI 取得）+ Unit Test | 1h | M3: 擊球動作與評估 | FALSE |  | 2026-07-25 | #109 |
| 7-3 | Block 7 | 確認 Action 資料格式（6 維，速度上限依 #176 實測） | 0.5h | M3: 擊球動作與評估 | FALSE |  | 2026-07-25 | #110 |
| 7-4 | Block 7 | 確認 ControllerBase：get_action(observation) → action 足以支撐未來 ModelController | 0.5h | M3: 擊球動作與評估 | FALSE |  | 2026-07-25 | #111 |
| 7-5 | Block 7 | 在 ScriptController 中加入 Observation 收集與 Action 格式輸出 | 0.5h | M3: 擊球動作與評估 | FALSE |  | 2026-07-26 | #112 |
| 9-1 | Block 9 | 研究 Isaac Lab 環境設計規範（gym.Env 介面） | 1h | M5: RL 訓練與多環境 | FALSE |  | 2026-07-26 | #120 |
| 9-2 | Block 9 | 實作 BilliardEnv：繼承 Isaac Lab 環境介面整合 core/ 邏輯（含 early termination） | 1.5h | M5: RL 訓練與多環境 | FALSE |  | 2026-07-26 | #121 |
| 9-3 | Block 9 | 確認 BilliardEnv 的 reset() step() observation_space action_space 正確 | 1h | M5: RL 訓練與多環境 | FALSE |  | 2026-07-27 | #122 |
| 9-4 | Block 9 | 選定 RL 演算法（PPO）設定超參數 | 0.5h | M5: RL 訓練與多環境 | FALSE |  | 2026-07-27 | #123 |
| 9-5 | Block 9 | 單環境訓練跑通確認（確認 reward 有在變化） | 1h | M5: RL 訓練與多環境 | FALSE |  | 2026-07-28 | #124 |
| 10-1 | Block 10 | 研究 Isaac Lab 多環境並行設計（Vectorized Environment） | 1h | M5: RL 訓練與多環境 | FALSE |  | 2026-07-29 | #129 |
| 10-2 | Block 10 | 調整 BilliardEnv 支援多環境實例化 | 1h | M5: RL 訓練與多環境 | FALSE |  | 2026-07-30 | #130 |
| 10-3 | Block 10 | 測試 8 台並行確認物理仿真穩定 | 0.5h | M5: RL 訓練與多環境 | FALSE |  | 2026-07-30 | #131 |
| 10-4 | Block 10 | 逐步擴大規模（32 → 64 → 128）記錄每個規模的 FPS | 1h | M5: RL 訓練與多環境 | FALSE |  | 2026-07-31 | #132 |
| 10-5 | Block 10 | 確認最大可穩定運行的環境數量 | 0.5h | M5: RL 訓練與多環境 | FALSE |  | 2026-08-01 | #133 |
| 9-6 | Block 9 | 確認訓練過程中 reward 曲線有上升趨勢（訓練跑背景，此為監控判讀） | 1h | M5: RL 訓練與多環境 | FALSE |  | 2026-08-01 | #125 |
| 9-7 | Block 9 | 儲存訓練好的模型確認可以載入並執行推論 | 0.5h | M5: RL 訓練與多環境 | FALSE |  | 2026-08-01 | #126 |
