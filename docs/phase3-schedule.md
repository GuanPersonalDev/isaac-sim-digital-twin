...
| B-1v | Block 13 | 逐球基座位置：Isaac Sim 場景碰撞檢查與真實 IK 驗證（依存 #180 的 `base_placement_calculator`，需 Extension 場景可載入，安排在場景驗證時一併確認） | 3h | M7: Milestone B 手臂執行 | FALSE |  | 2026-08-29 | #233 |
