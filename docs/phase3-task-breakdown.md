...
| 項目 | 數值 |
|---|---|
| 出桿速度範圍 | 0.5 ~ 1.3 m/s（#176 實測 2026-07-17：UR5 直線推桿沿桿軸向峰值 1.313 m/s，蓄力摺疊姿、手肘主驅動下的物理上限；RL action space 必須以此為速度上限。已另開優化任務改用 shoulder_pan 切線推桿，理論估 1.9~2.7 m/s，優化完成後更新此值） |
| 出桿角度範圍 | 0 ~ 360 度 |
| 擊球位置偏移範圍 | ±0.5 球半徑 |
